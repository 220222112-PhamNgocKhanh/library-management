...
public class Document {
  ...
  public Document(String title, String author, String category, String status, int quantity,
    ...
    this.borrowDate = null; // Chưa được mượn
  }
  ...
  public Document(int idDocument, String title, String author, String category, String status,
      int quantity,
      String publisher, String publishedDate, String description, String isbn13, String isbn10) {
    this.title = title;
    this.author = author;
  ...
  public boolean isOverdue() {
    // Kiểm tra nếu ngày mượn đã quá 3 tháng tính từ hôm nay
    return borrowDate != null && borrowDate.plusMonths(3).isBefore(LocalDate.now());
  }
