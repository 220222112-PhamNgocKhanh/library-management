    ...
    private void addUser() {
        ...
        if (userName != null && !userName.isEmpty()) {
            ...
            if (userId != null && !userId.isEmpty()) {
                ...
                emailDialog.setHeaderText("Nhập email thành viên:");
                emailDialog.initOwner(this);
                String userEmail = emailDialog.showAndWait().orElse(null);
    ...
    private void borrowDocument() {
        ...
        if (selectedUserIndex != -1) {
            ...
            if (selectedDocument.getQuantity() > 0) {
                ...
                selectedDocument.setQuantity(selectedDocument.getQuantity() - 1); //Here
