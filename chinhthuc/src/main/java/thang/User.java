...
public class User {
  ...
  /**
   * public void borrowBook(Document book) { if (!borrowedBooks.contains(book)) {
   * borrowedBooks.add(book);  // Thêm sách vào danh sách mượn book.setQuantity(book.getQuantity() -
  ...
  /**
   * public void returnBook(Document book) { if (borrowedBooks.contains(book)) {
